CXX = g++
CXXFLAGS = -std=c++11 -Wall -fexceptions -Wno-deprecated-declarations  -m64  -Wdeprecated-declarations `xml2-config --cflags` -fPIC -DTERMINATE_IN_STD -DTYPEINFO_IN_STD
